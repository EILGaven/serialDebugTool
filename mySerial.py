...
class MainWindow(QMainWindow):
    ...
    def read_setting(self):
        ...
        if setting.value('port_name') is not None:
            self.ui.serialSelection.setCurrentIndex(int(setting.value('port_name')))
        if setting.value('baudrate') is not None:
            self.ui.baudrateSelection.setCurrentIndex(int(setting.value('baudrate')))
    ...
    def open_port(self):
        ...
        if self.currentPort is None:
            ...
            print('currentByteSize:',currentByteSize,'type:',type(currentByteSize))
            ...
            self.currentPort = open_port(currentPortName,currentBaudrate, currentByteSize, currentStopBit, currentParity)
    ...
    def initialize_ui(self):
        ...
        baudrateList = ['1200','2400','4800','9600','19200','38400','115200']
